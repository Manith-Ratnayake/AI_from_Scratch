...
class block(nn.Module):
    def __init__(self, in_channel, out_channels, identity_downsample=None, stride=1):
        super(block, self).__init__()
        self.expansion           = 4
        self.conv1               = nn.Conv2d(in_channel, out_channels, kernel_size = 1, stride = 1, padding=0)
